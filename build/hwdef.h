...
#define HAL_SPI_DEVICE1  SPIDesc("icm20948"       ,  2,  3, PAL_LINE(GPIOC,13U), SPIDEV_MODE3,   2*MHZ,   4*MHZ)
#define HAL_SPI_DEVICE2  SPIDesc("bmp280"         ,  0,  2, PAL_LINE(GPIOE,9U) , SPIDEV_MODE3,   1*MHZ,   8*MHZ)
#define HAL_SPI_DEVICE3  SPIDesc("bmp388"         ,  2,  4, PAL_LINE(GPIOE,4U) , SPIDEV_MODE3,   5*MHZ,  10*MHZ)
...
#define STM32_UART_USART1_TX_DMA_STREAM STM32_DMA_STREAM_ID(2, 5)
...
#endif
#define HAL_SERIAL_DEVICE_LIST HAL_OTG1_CONFIG,HAL_USART1_CONFIG,HAL_USART2_CONFIG,HAL_USART3_CONFIG,HAL_UART5_CONFIG,HAL_UART8_CONFIG,HAL_UART7_CONFIG,HAL_OTG2_CONFIG
